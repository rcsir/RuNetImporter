...
public class FormPlus : System.Windows.Forms.Form
{
    ...
    )
    {
        ...
        foreach (Control oChildControl in oParentControl.Controls)
        {
            ...
            {
                CheckCheckBoxes( bCheck, ( (CheckBox)oChildControl ) );
            }
            else
            {
    ...
    (
        Boolean bCheck,
        params CheckBox[] aoCheckBoxes
    )
    {
        Debug.Assert(aoCheckBoxes != null);
        AssertValid();

        foreach (CheckBox oCheckBox in aoCheckBoxes)
        {
            oCheckBox.Checked = bCheck;
        }
    }
    ...
    )
    {
        ...
        return ( FormUtil.OnInvalidControl(control, errorMessage) );
    }
...
public class FormUtil : Object
{
    ...
    )
    {
        ...
        String sFormat = "N" + oNumericUpDown.DecimalPlaces.ToString();
        ...
        return ( OnInvalidNumericUpDown( oNumericUpDown,
            ...
            String.Format(
                ...
                sValueDescription,
                oNumericUpDown.Minimum.ToString(sFormat),
                oNumericUpDown.Maximum.ToString(sFormat)
                ) ) );
    }
